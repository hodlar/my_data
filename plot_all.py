...
plt.plot(z2, h2, 'r--', label = '1G')
plt.plot(z3, h3, 'g--', label = '2G')
plt.plot(z4, h4, 'b--', label = '3G')
...
plt.xlabel('T')
plt.ylabel('Density')
plt.plot(z,rel1, 'm--', label='0G')
plt.plot(z, rel2, 'r--', label='0G')
plt.plot(z, rel3, 'g--', label='0G')
plt.legend(bbox_to_anchor=(0., 1.02, 1., .102), loc=3, ncol=2, mode="expand", borderaxespad=0)
