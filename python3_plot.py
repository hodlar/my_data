...
plt.xlabel('z [km]')
plt.ylabel('H [cm-3]')
plt.plot(zdens, h0dens, 'm', label='0G')
plt.plot(zdens, h1dens, 'r', label = field1)
plt.plot(zdens, h2dens, 'g', label = field2)
plt.plot(zdens, h3dens, 'b', label = field3)
ax.set_yscale('log')
plt.legend()
...
plt.xlabel('z [km]')
plt.ylabel('Differenre in H [cm-3]')
plt.plot(zabs, abs1)
plt.plot(zabs, abs2)
plt.plot(zabs, abs3)
ax.set_yscale('log')
