...
zc = numpy.log(z[1:50]+150)/numpy.log(10)
h0c = numpy.log(h0[1:50])/numpy.log(10)
h1c = numpy.log(h1[1:50])/numpy.log(10)
h2c = numpy.log(h2[1:50])/numpy.log(10)
h3c = numpy.log(h3[1:50])/numpy.log(10)
plt.figure(num='primeros 50 datos')
plt.xlabel('Altura log(x)/log(10) sobre fotosfera (incrementada en 150) [km]')
plt.ylabel('Densidades log(y)/log(10) de hidrogeno [cm-3]')
plt.plot(zc, h0c, 'm--', label='0G')
plt.plot(zc, h1c, 'r--', label = field1)
plt.plot(zc, h2c, 'g--', label = field2)
plt.plot(zc, h3c, 'b--', label = field3)
plt.legend(bbox_to_anchor=(0.5, 1.02, 0.5, .102), loc=3, ncol=2, mode="expand", borderaxespad=0)
...
z = numpy.log(z[1:140] + 150)/numpy.log(10)
h0 = numpy.log(h0[1:140])/numpy.log(10)
h1 = numpy.log(h1[1:140])/numpy.log(10)
h2 = numpy.log(h2[1:140])/numpy.log(10)
h3 = numpy.log(h3[1:140])/numpy.log(10)
plt.figure(num='todos los datos')
plt.xlabel('Altura log(x)/log(10) sobre fotosfera (incrementada en 150) [km]')
plt.ylabel('Densidades log(y)/log(10) de hidrogeno [cm-3]')
